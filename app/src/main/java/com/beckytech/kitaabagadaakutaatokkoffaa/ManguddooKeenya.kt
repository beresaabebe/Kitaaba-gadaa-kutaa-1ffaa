...
class ManguddooKeenya : AppCallOutside() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val tit = "Manguddoota keenya"
        binding.titleTv.text = tit

        binding.backBtn.setOnClickListener { onBackPressed() }
        binding.menuBtn.setOnClickListener { openPopupMenu(this@ManguddooKeenya, binding.menuBtn) }
    }
